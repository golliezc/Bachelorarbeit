...
\newcommand{\mytitle}{Verbesserung des Velonetz in Uster in angesicht der unsicheren zukünftigen Nachfragebeziehungen}  %% also used for PDF metadata (hyperref)
...
\input{content/00-04-Abstract}

% Zusammenfassung
% --------
\cleardoublepage
\addcontentsline{toc}{chapter}{Zusammenfassung}
\input{content/00-05-Zusammenfassung}

% Hilfestellung Template
% ----------------------
\cleardoublepage
\addcontentsline{toc}{chapter}{Hilfestellung}
\input{content/00-06-Hilfestellung} 
...
% Chapter 2
% ---------
\input{content/02-Grundlagen und Theorie}

% Chapter 3
% ---------
\input{content/03-Vorgehen und Methodik}

% Chapter 4
% ---------
\input{content/04-Fallstudie}

% Chapter 5
% ---------
\input{content/05-Resultate}

% Chapter 6
% ---------
\input{content/06-Diskussion}

% Chapter 7
% ---------
\input{content/07-Schlussfolgerung}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\textwidth]{figures/f-04-03-Unfallrisiko-Schätzung.pdf}
